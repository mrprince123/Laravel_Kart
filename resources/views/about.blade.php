...
<div class="w-2/3 m-auto mt-10 mb-20">
    <div class="m-2 p-2 text-center mb-10 mt-10">
        ...
        <img class="w-full rounded-lg" src="https://img1.wsimg.com/isteam/stock/D1Bw1oB/:/rs=w:1023,h:512,cg:true,m/cr=w:1023,h:512"
            alt="">
    ...
    <div class="grid grid-cols-2 gap-4">
        <div class=" m-2 p-2 text-center rounded-lg bg-slate-100">
    ...
    <div class="flex items-center mt-10">
        <img class="w-1/2 m-2 rounded-lg"
        ...
        <div class="m-2 p-2">
            ...
            <a href=""><button class="bg-black mt-2 rounded-lg text-white font-medium p-2">FIND OUT MORE</button></a>
        </div>
