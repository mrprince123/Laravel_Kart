...
<body>
    ...
    <div class="bg-slate-200 flex">
        ...
        <div class="bg-white rounded-xl drop-shadow-2xl text-center p-2 w-1/4 m-auto">
            <h1 class="text-3xl font-bold text-center">Admin Register</h1>
            @if ($errors->any())
            ...
            <form action="{{ url('/admin/register') }}" method="post" class="mt-2 gap-4 flex flex-col p-2">
                @csrf
            ...
            <p>Have account ? <a href="{{ url('/admin/login') }}" class="text-blue-400">Admin Login</a></p>
